...
class App {
    ...
    _processAnimation() {
        ...
        if(this._move_flag==0){
            if(this._clickedBtns["1"]){
                ...
                if(this._model_x.position.x!=0 && this._model_x.position.y!=0){
                    this._w_flag = 1;
                    this._w_dir_flag = 1;
                    this._move_flag = 1;
    ...
    update(time) {
        ...
        //water
        else if(this._w_flag){
            if(this._w_dist_flag<100 && this._w_dir_flag==1){
                this._model_x.position.x -= 2;
                this._w_dist_flag += 2;
            }
            else if(this._w_dist_flag<300 && this._w_dir_flag==1){
                this._w_dist_flag += 2;
            }
            //direction change
            else if(this._w_dir_flag==1) this._w_dir_flag=-1;
            else if(this._w_dist_flag>100 && this._w_dir_flag==-1){
                this._w_dist_flag -= 2;
            }
            else if(this._w_dist_flag>0 && this._w_dir_flag==-1){
                this._model_x.position.x += 2;
                this._w_dist_flag -= 2;
            }
            else{
